...
<footer id="colophon" class="bg-white border-t">
    ...
    <div class="container px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-4 justify-between items-center mb-12s">
            <!-- first col has a logo, then social media  below it -->
            <div class="col-span-1">
                <div class="site-branding flex py-4">
                    <a class="flex" href="<?php echo esc_url(home_url('/')); ?>" style="height: <?php echo $nav_height ? $nav_height : 90; ?>px;">
                        <img src="<?php echo esc_url($logo); ?>'" alt="<?php echo get_bloginfo('name'); ?>" />
                    </a>
                </div>

                <div class="flex space-x-2" style="font-size: 20px;">
